...
TimelineMoveClips::TimelineMoveClips(gui::timeline::Timeline& timeline, model::Clips drags, Drops drops)
:   TimelineCommand(timeline)
,   mParams()
,   mDrags(drags)
,   mDrops(drops)
...
void TimelineMoveClips::split(model::TrackPtr track, pts position, ReplacementMap* conversionmap)
{
...
void TimelineMoveClips::replaceClip(model::ClipPtr original, model::Clips replacements, ReplacementMap* conversionmap)
{
...
void TimelineMoveClips::replaceLinks(ReplacementMap& conversionmap)
{
...
void TimelineMoveClips::newMove(model::TrackPtr addTrack, model::ClipPtr addPosition, model::Clips addClips, model::TrackPtr removeTrack, model::ClipPtr removePosition, model::Clips removeClips)
{
...
std::ostream& operator<<( std::ostream& os, const TimelineMoveClips::PasteInfo& obj )
{
