...
<tr><td><ul>
  ...
  <xsl:for-each select="logentry">
    ...
    <xsl:if test="$revision>1220">
      <xsl:choose>
        <xsl:when test="$revision=2169"><![CDATA[</ul></td></tr><tr><td><h2>]]>Release 0.3.18  (revision <xsl:value-of select="$revision" />)<![CDATA[</h2></td></tr><tr><td><ul>]]></xsl:when>
        <xsl:when test="$revision=2164"><![CDATA[</ul></td></tr><tr><td><h2>]]>Release 0.3.17  (revision <xsl:value-of select="$revision" />)<![CDATA[</h2></td></tr><tr><td><ul>]]></xsl:when>
        <xsl:when test="$revision=2121"><![CDATA[</ul></td></tr><tr><td><h2>]]>Release 0.3.16  (revision <xsl:value-of select="$revision" />)<![CDATA[</h2></td></tr><tr><td><ul>]]></xsl:when>
        <xsl:when test="$revision=2052"><![CDATA[</ul></td></tr><tr><td><h2>]]>Release 0.3.15  (revision <xsl:value-of select="$revision" />)<![CDATA[</h2></td></tr><tr><td><ul>]]></xsl:when>
        <xsl:when test="$revision=1990"><![CDATA[</ul></td></tr><tr><td><h2>]]>Release 0.3.14  (revision <xsl:value-of select="$revision" />)<![CDATA[</h2></td></tr><tr><td><ul>]]></xsl:when>
        <xsl:when test="$revision=1897"><![CDATA[</ul></td></tr><tr><td><h2>]]>Release 0.3.13  (revision <xsl:value-of select="$revision" />)<![CDATA[</h2></td></tr><tr><td><ul>]]></xsl:when>
        <xsl:when test="$revision=1865"><![CDATA[</ul></td></tr><tr><td><h2>]]>Release 0.3.12  (revision <xsl:value-of select="$revision" />)<![CDATA[</h2></td></tr><tr><td><ul>]]></xsl:when>
        <xsl:when test="$revision=1839"><![CDATA[</ul></td></tr><tr><td><h2>]]>Release 0.3.11  (revision <xsl:value-of select="$revision" />)<![CDATA[</h2></td></tr><tr><td><ul>]]></xsl:when>
        <xsl:when test="$revision=1828"><![CDATA[</ul></td></tr><tr><td><h2>]]>Release 0.3.10  (revision <xsl:value-of select="$revision" />)<![CDATA[</h2></td></tr><tr><td><ul>]]></xsl:when>
        <xsl:when test="$revision=1821"><![CDATA[</ul></td></tr><tr><td><h2>]]>Release 0.3.9  (revision <xsl:value-of select="$revision" />)<![CDATA[</h2></td></tr><tr><td><ul>]]></xsl:when>
