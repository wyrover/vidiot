...
public:
    ...
    WipeCircle* clone() const override;

    virtual ~WipeCircle() = default;
...
protected:
    ...
    /// \see make_cloned
    WipeCircle(const WipeCircle& other) = default;
...
BOOST_CLASS_VERSION(model::video::transition::WipeCircle, 1)
BOOST_CLASS_EXPORT_KEY(model::video::transition::WipeCircle)
